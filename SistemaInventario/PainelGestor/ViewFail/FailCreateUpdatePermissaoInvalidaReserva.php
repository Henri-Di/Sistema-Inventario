    ...
    Você não tem permissã para modificar o status desta reserva. Somente o usuário que criou a reserva pode modificar seu status <i class='fa fa-times-circle'></i>
