...
<head>
    ...
    <!-- Title page -->
    <title>Sistema de Inventário - Relatório Localização</title>
...
<div id="blue-line-title-btn-painel">
    <p id="blue-title-btn-painel">Relatório Material <i class="fa fa-puzzle-piece" id="blue-icon-btn-painel" style="font-size:12px;"></i></p>
</div>
    ...
    <table class="table table-bordered" id="blue-table-cadastro-auxiliars">
        <tr id="line-blue-table-hover">
            <td id="colun-blue-table">
                ...
                <p id="blue-text-table-exibicao"><?php echo $dado['IDLOCALIZACAO']; ?></p>
            </td>
            <td id="colun-blue-table">
                <p id="blue-title-listar-exibicao">Grupo</p>
                <p id="blue-text-table-exibicao"><?php echo $dado['LOCALIZACAO']; ?></p>
            </td>
            <td id="colun-blue-table">
                <p id="blue-title-listar-exibicao">Modificar</p> 
                <div id="blue-optios-config-dados" onclick="window.location.href='../ViewForms/ModificarLocalizacao.php?id=<?php echo $dado['IDLOCALIZACAO'];?>';">
                    <i class="fa fa-pencil" id="blue-icon-relatorio-produto"></i>
                </div>
            </td>
            <td id="colun-blue-table">
                <p id="blue-title-listar-exibicao">Remover</p> 
                <div id="blue-optios-config-dados" onclick="window.location.href='../ViewForms/DeleteLocalizacao.php?id=<?php echo $dado['IDLOCALIZACAO'];?>';">
