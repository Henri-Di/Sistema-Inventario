...
<?php } ?>
   ...
   <?php
    ...
    <div id="blue-optios-config-dados" onclick="window.location.href='../ViewForms/ModificarMetragem.php?id=<?php echo $dado['IDMETRAGEM'];?>';"><i class="fa fa-pencil" id="blue-icon-relatorio-produto" ></i></div> 
    ...
    <div id="blue-optios-config-dados" onclick="window.location.href='../ViewForms/DeleteMetragem.php?id=<?php echo $dado['IDMETRAGEM'];?>';"><i class="fa fa-trash" id="blue-icon-relatorio-produto"></i></div> 
