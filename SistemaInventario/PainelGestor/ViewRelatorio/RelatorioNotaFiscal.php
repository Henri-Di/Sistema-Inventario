...
<head>
    ...
    <!-- Title page -->
    <title>Sistema de Inventário - Relatório Nota Fiscal</title>
...
<div class="container" id="blue-search">
    ...
    <!-- Fim do formulário de busca de material -->
</div>
<!-- Fim do contêiner de busca de material -->

<br>

<!-- Início do título da seção de relatório -->
<div id="blue-line-title-btn-painel">
    <p id="blue-title-btn-painel">Relatório Nota Fiscal <i class="fa fa-cart-plus" id="blue-icon-btn-painel" style="font-size:12px;"></i></p>
</div>
<!-- Fim do título da seção de relatório -->

<!-- Contêiner para o conteúdo do relatório -->
<div class="container-fluid" style="width:100%;height:541px;overflow-y:auto;">

    <br>

    <!-- Início do código PHP para realizar a consulta dos dados -->
    <?php 
    ...
    ?> 
    <!-- Fim do código PHP para realizar a consulta dos dados -->

    <!-- Início do código PHP para repetição de listagem -->
    <?php while($dado = $con->fetch_array()) { ?> 

    <!-- Início do código PHP para conversão da data para o modelo brasileiro -->
    <?php 
    ...
    ?>
    <!-- Fim do código PHP para conversão da data para o modelo brasileiro -->

    <!-- Início da tabela para exibição dos dados -->
    <table class="table table-bordered" id="blue-table-cadastro-auxiliar">
        <tr id="line-blue-table-hover">
            ...
            <td id="colun-blue-table">
                <p id="blue-title-listar-exibicao">Custo</p>
            ...
            <td id="colun-blue-table">
                ...
                <div id="blue-optios-config-dados" onclick="window.location.href='../ViewForms/ModificarNotaFiscal.php?id=<?php echo $dado['ID'];?>';">
            ...
            <td id="colun-blue-table">
                <div id="blue-title-listar-exibicao">Download</div>
                <a id="blue-optios-config-dados" href='../ViewFunctions/CreateDownloadNotaFiscal.php?file=<?php echo urlencode($dado['FILEPATH']); ?>'>
                    <i class="fa fa-cloud-download" style="margin-left:40%;margin-top:25%;font-size:9px;"></i>
                </a>
            </td>
        </tr>
    </table>
    <!-- Fim da tabela para exibição dos dados -->

    <?php } ?>
    <!-- Fim do código PHP para repetição de listagem -->
</div>
<!-- Fim do contêiner para o conteúdo do relatório -->
 <!-- Rodapé da página -->
