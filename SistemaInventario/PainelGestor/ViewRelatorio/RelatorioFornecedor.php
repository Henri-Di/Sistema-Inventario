...
<?php } ?>
   ...
   <?php
    ...
    <div id="blue-optios-config-dados" onclick="window.location.href='../ViewFail/FailCreateSemPermissao.php?id=<?php echo $dado['IDFORNECEDOR'];?>';"><i class="fa fa-pencil" id="blue-icon-relatorio-produto" ></i></div> 
    ...
    <div id="blue-optios-config-dados" onclick="window.location.href='../ViewFail/FailCreateSemPermissao.php?id=<?php echo $dado['IDFORNECEDOR'];?>';"><i class="fa fa-trash" id="blue-icon-relatorio-produto"></i></div> 
