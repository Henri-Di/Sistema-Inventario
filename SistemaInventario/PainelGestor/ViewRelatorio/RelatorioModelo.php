...
<?php } ?>
   ...
   <?php
    ...
    <div id="blue-optios-config-dados" onclick="window.location.href='../ViewForms/ModificarMordelo.php?id=<?php echo $dado['IDMODELO'];?>';"><i class="fa fa-pencil" id="blue-icon-relatorio-produto" ></i></div> 
    ...
    <div id="blue-optios-config-dados" onclick="window.location.href='../ViewForms/DeleteModelo.php?id=<?php echo $dado['IDMODELO'];?>';"><i class="fa fa-trash" id="blue-icon-relatorio-produto"></i></div> 
