...
<head>
    ...
    <!-- Title page -->
    <title>Sistema de Inventário - Relatório Grupo</title>
    ...
    <table class="table table-bordered" id="blue-table-cadastro-auxiliars">
        <tr id="line-blue-table-hover">
            <td id="colun-blue-table">
                ...
                <p id="blue-text-table-exibicao"><?php echo $dado['IDGRUPO']; ?></p>
            </td>
            <td id="colun-blue-table">
                <p id="blue-title-listar-exibicao">Grupo</p>
                <p id="blue-text-table-exibicao"><?php echo $dado['GRUPO']; ?></p>
            </td>
            <td id="colun-blue-table">
                <p id="blue-title-listar-exibicao">Modificar</p> 
                <div id="blue-optios-config-dados" onclick="window.location.href='../ViewForms/ModificarGrupo.php?id=<?php echo $dado['IDGRUPO'];?>';">
                    <i class="fa fa-pencil" id="blue-icon-relatorio-produto"></i>
                </div>
            </td>
            <td id="colun-blue-table">
                <p id="blue-title-listar-exibicao">Remover</p> 
                <div id="blue-optios-config-dados" onclick="window.location.href='../ViewForms/DeleteGrupo.php?id=<?php echo $dado['IDGRUPO'];?>';">
