...
<div class="container-fluid" style="margin-left:25%;">
    <table class="table table-bordered" style="width:60%;height:auto;">
        <form method="POST" class="example" action="">
            ...
            <?php 
                ...
                $consulta = "SELECT * FROM GRUPO WHERE IDGRUPO='$id'";
            ...
            <?php while($dado = $con->fetch_array()) { ?> 
                <tr id="line-blue-table">
                    <td id="colun-blue-table">   
                        ...
                        <input type="text" id="blue-input-cdst" value="<?php echo $dado['IDGRUPO']; ?>" name="id" disabled>
                        <input type="hidden" id="blue-input-cdst" value="<?php echo $dado['IDGRUPO']; ?>" name="id">
                    </td>
            <?php } ?>
            ...
            <?php while($dado = $con->fetch_array()) { ?> 
                    <td id="colun-blue-table">   
                        ...
                        <input type="text" id="blue-input-cdst" value="<?php echo $dado['GRUPO']; ?>" name="Grupo" disabled/>
                        <input type="hidden" id="blue-input-cdst" value="<?php echo $dado['GRUPO']; ?>" name="Grupo"/>
                    </td>
                </tr>
            <?php } ?>
            <!-- Fim do código PHP para repetição de listagem -->
    ...
    <button type="submit" id="blue-btn-table-cadastro-produto" onclick="window.location.href='../ViewFunctions/CreateDeleteGrupo.php?id=<?php echo $dado['IDMATERIAL'];?>';">Remover Material <i class="fa fa-trash"></i></button>
    </form>
</div>
