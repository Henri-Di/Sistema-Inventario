...
<?php } ?>
    ...
    <p id="blue-title-btn-painel">Deseja realizar a remoção do conector:</p>
    ...
    <button type="submit" id="blue-button-nova-senha" onclick="window.location.href='CreateDeleteConector.php?id=<?php echo $dado['IDCONECTOR'];?>';">Remover Conector  <i class="fa fa-trash"></i></button>
