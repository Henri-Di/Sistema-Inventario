...
<?php } ?>
    ...
    <p id="blue-title-btn-painel">Deseja realizar a remoção do material:</p>
    ...
    <button type="submit" id="blue-button-nova-senha" onclick="window.location.href='CreateDeleteMaterial.php?id=<?php echo $dado['IDMATERIAL'];?>';">Remover Material  <i class="fa fa-trash"></i></button>
