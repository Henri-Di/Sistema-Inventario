	...
	<!-- Title page -->
    <title>Sistema de Inventário - Sobrepor Produto</title>	
...
<?php } ?>
    ...
    <form method="POST" action="../ViewFunctios/CreateReserva.php">
    ...
    <p id="blue-title-listar">Quantidade Reservada</p> 
    ...
    <p id="blue-title-listar">Data Reseva</p> 
