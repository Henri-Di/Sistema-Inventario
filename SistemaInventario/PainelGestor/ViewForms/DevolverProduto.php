...
<?php } ?>
    ...
    <p id="blue-title-listar">Quantidade Devolvida</p> 
        


    <input id="blue-input-cdst" type="number" value="" name="Devolvida" autocomplete="off" required/>
    ...
    <p id="blue-title-listar">Data Devolução</p> 
