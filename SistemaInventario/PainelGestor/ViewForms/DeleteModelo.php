...
<?php } ?>
    ...
    <p id="blue-title-btn-painel">Deseja realizar a remoção do modelo:</p>
    ...
    <button type="submit" id="blue-button-nova-senha" onclick="window.location.href='CreateDeleteModelo.php?id=<?php echo $dado['IDMODELO'];?>';">Remover Modelo  <i class="fa fa-trash"></i></button>
