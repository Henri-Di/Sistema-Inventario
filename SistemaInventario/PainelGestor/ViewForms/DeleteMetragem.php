...
<div class="container-fluid">
    ...
    <p id="blue-title-btn-painel">Remover Metragem <i class="fa fa-trash" id="blue-icon-btn-painel" style="font-size:12px;"></i></p>
</div>
<br>
<div class="container-fluid" style="margin-left:25%;">
    ...
    <button type="submit" id="blue-btn-table-cadastro-produto" onclick="window.location.href='../ViewFunctions/CreateDeleteMetragem.php?id=<?php echo $dado['IDMETRAGEM'];?>';">Remover Metragem <i class="fa fa-trash"></i></button>
    </form>
</div>
