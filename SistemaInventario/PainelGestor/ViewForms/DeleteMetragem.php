...
<?php } ?>
    ...
    <p id="blue-title-btn-painel">Deseja realizar a remoção da metragem:</p>
    ...
    <button type="submit" id="blue-button-nova-senha" onclick="window.location.href='CreateDeleteMetragem.php?id=<?php echo $dado['IDMETRAGEM'];?>';">Remover Metragem  <i class="fa fa-trash"></i></button>
