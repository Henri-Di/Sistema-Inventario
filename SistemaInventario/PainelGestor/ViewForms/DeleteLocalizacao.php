...
<head>
    ...
    <!-- Title page -->
    <title>Sistema de Inventário - Remover Grupo</title>
...
<div class="container-fluid">
    ...
    <p id="blue-title-btn-painel">Remover Grupo <i class="fa fa-trash" id="blue-icon-btn-painel" style="font-size:12px;"></i></p>
</div>
<br>
<div class="container-fluid" style="margin-left:25%;">
    <table class="table table-bordered" style="width:60%;height:auto;">
        <form method="POST" class="example" action="">
            ...
            <?php 
                ...
                $consulta = "SELECT * FROM LOCALIZACAO WHERE IDLOCALIZACAO='$id'";
            ...
            <?php while($dado = $con->fetch_array()) { ?> 
                <tr id="line-blue-table">
                    <td id="colun-blue-table">   
                        ...
                        <input type="text" id="blue-input-cdst" value="<?php echo $dado['IDLOCALIZACAO']; ?>" name="id" disabled>
                        <input type="hidden" id="blue-input-cdst" value="<?php echo $dado['IDLOCALIZACAO']; ?>" name="id">
                    </td>
            <?php } ?>
            ...
            <?php while($dado = $con->fetch_array()) { ?> 
                    <td id="colun-blue-table">   
                        ...
                        <input type="text" id="blue-input-cdst" value="<?php echo $dado['LOCALIZACAO']; ?>" name="Localizacao" disabled/>
                        <input type="hidden" id="blue-input-cdst" value="<?php echo $dado['LOCALIZACAO']; ?>" name="Localizacao"/>
                    </td>
                </tr>
            <?php } ?>
            <!-- Fim do código PHP para repetição de listagem -->
    ...
    <button type="submit" id="blue-btn-table-cadastro-produto" onclick="window.location.href='../ViewFunctions/CreateDeleteLocalizacao.php?id=<?php echo $dado['IDMATERIAL'];?>';">Remover Material <i class="fa fa-trash"></i></button>
    </form>
</div>
