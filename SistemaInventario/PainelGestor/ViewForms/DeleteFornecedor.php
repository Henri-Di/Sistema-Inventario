...
<?php } ?>
    ...
    <p id="blue-title-btn-painel">Deseja realizar a remoção do fornecedor:</p>



    <div class="container-fluid" style="margin-left:26%;">
    ...
    <button type="submit" id="blue-button-nova-senha" onclick="window.location.href='CreateDeleteFornecedor.php?id=<?php echo $dado['IDFORNECEDOR'];?>';">Remover Fornecedor  <i class="fa fa-trash"></i></button>
