...
// Verifica se o usuário está autenticado, caso contrário, redireciona para a página de erro
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Obtém e sanitiza os dados do usuário da sessão
    ...
    try {
        // Consulta para obter detalhes da reserva
        ...
        // Verifica se a situação da reserva é 'PENDENTE'
        ...
        // Verifica se o usuário atual é o criador da reserva
        ...
        // Verifica a quantidade de reservas pendentes para o produto
        ...
        // Atualiza o estoque com base na ação da reserva (CANCELADA ou CONCLUIDA)
        ...
        // Fecha os prepared statements e a conexão com o banco de dados
