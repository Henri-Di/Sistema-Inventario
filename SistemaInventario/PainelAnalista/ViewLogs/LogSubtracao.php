...
?>
    ...
    $date = strtotime($dado['DATASUBTRACAO']);
    // $data agora é uma inteiro timestamp
    ...
    <input type="text" id="blue-input-cdst" name="CodigoDiminiur" value="<?php echo $dado['ID'];?> " autocomplete="off" required disabled /><br>
    ...
    <input type="text" id="blue-input-cdst" name="DataSubtracao" value="<?php echo $dateformated;?> " autocomplete="off" required disabled /><br>
