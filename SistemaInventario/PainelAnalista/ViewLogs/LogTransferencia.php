...
if ($stmt = $conn->prepare($sql)) {
    ...
    <input type="text" id="blue-input-cdst" name="QuantidadeTransferida" value="<?php echo $row['IDPRODUTO_ORIGEM'];?> " autocomplete="off" required disabled /><br>
    ...
    <input type="text" id="blue-input-cdst" name="QuantidadeTransferida" value="<?php echo $row['IDPRODUTO_DESTINO'];?> " autocomplete="off" required disabled /><br>
   ...
   <td id="colun-blue-table">
    ...
    <input type="text" id="blue-input-cdst" name="SituacaoTransferencia" value="<?php echo $row['SITUACAO'];?> " autocomplete="off" required disabled /><br>
