...
<div class="container-fluid">
    ...
    <div class="alert">
        ...
        <!-- Mensagem de erro -->
        A reserva não pode ser alterada pois já foi concluída ou cancelada. Tente novamente com uma reserva que esteja com o status pendente <i class='fa fa-times-circle'></i>
    </div>
    <style>
                    .alerts {
                        padding: 5px;
