...
<div class="container-fluid">
    ...
    <div class="alert">
        ...
        <!-- Mensagem de erro -->
        Não foi possível atualizar a quantidade reservada do produto de origem da transferência. Refaça a operação e tente novamente <i class='fa fa-times-circle'></i>
    </div>
    <style>
                    .alerts {
                        padding: 5px;
