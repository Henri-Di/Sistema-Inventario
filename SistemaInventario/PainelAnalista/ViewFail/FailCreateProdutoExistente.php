...
<div class="container-fluid">
    ...
    <div class="alert">
        ...
        <!-- Mensagem de erro -->
        Não foi possível realizar o cadastro do produto. O produto já está cadastrado no sistema. Refaça a operação e tente novamente <i class='fa fa-times-circle'></i>
    </div>
    <style>
                    .alerts {
                        padding: 5px;
