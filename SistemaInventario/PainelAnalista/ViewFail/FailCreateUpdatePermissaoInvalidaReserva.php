...
<div class="container-fluid">
    ...
    <div class="alert">
        ...
        <!-- Mensagem de erro -->
        Você não tem permissão para modificar o status desta reserva. Somente o usuário que criou a reserva pode modificar seu status <i class='fa fa-times-circle'></i>
    </div>
    <style>
                    .alerts {
                        padding: 5px;
