...
try {
    ...
    if ($idUsuario !== $idUsuarioCriador) {
        header("Location: ../ViewFail/FailCreateUpdatePermissaoInvalidaReserva.php?erro=Você não tem permissã para modificar o status desta reserva. Somente o usuário que criou a reserva pode modificar seu status");
        exit();
    }
    ...
    if (!$stmtUpdateReserva->execute()) {
        header("Location: ../ViewFail/FailCreateUpdateReserva.php?erro=Você não tem permissã para modificar o status desta reserva. Somente o usuário que criou a reserva pode modificar seu status");
        exit();
    }
