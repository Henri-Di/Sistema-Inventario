...
<div id="blue-line-title-btn-painel">
    <p id="blue-title-btn-painel"> Devolver Produto <i class="fa fa-exchange" id="blue-icon-btn-painel"></i></p>
</div>
...
if ($resultado->num_rows === 0) {
    ...
    <!-- Início do loop PHP para repetição de listagem -->
    <?php while($dado = $resultado->fetch_assoc()) { ?>
        ...
        <!-- Início do formulário e tabela para listar os detalhes do produto -->
        <br>
            ...
            <tr id="line-blue-table">
                <form method="POST" action="CreateReserva.php">
                    <td id="colun-blue-table">
                        ...
                        <!-- Container para título do campo de entrada -->
    ...
    <table class="table table-bordered" id="blue-table-cadastro-auxiliar">
        <tr id="line-blue-table">
            ...
            <td id="colun-blue-table">
                ...
                <input id="blue-input-cdst" type="date" value="" name="DataDevolucao" autocomplete="off" required/>
            </td>
