...
<div id="blue-line-title-btn-painel">
        <p id="blue-title-btn-painel">Inutilizar Produto <i class="fa fa-warning" id="blue-icon-btn-painel"></i></p>
    </div>
    ...
    if ($resultado->num_rows === 0) {
        ...
        <?php } ?>
        <!-- Fim do PHP para repetição de listagem -->
    <?php } ?>    
<?php
// Conexão e consulta ao banco de dados
require_once('../../ViewConnection/ConnectionInventario.php'); 
...
<!-- Início do formulário para inutilizar material -->
<form method="POST" action="../ViewFunctions/CreateInutilizar.php">
    <table class="table table-bordered" id="blue-table-cadastro-auxiliar">
        <tr id="line-blue-table">
            <td id="colun-blue-table">
                <input id="blue-input-cdst" name="id" type="hidden" value="<?php echo $dado['IDPRODUTO']; ?>"/>
                <p id="blue-title-listar">Quantidade Atual</p> 
                <input id="blue-input-cdst" type="text" value="<?php echo $dado['QUANTIDADE']; ?>" name="Quantidade" disabled/>
            </td>
            <td id="colun-blue-table">
                <p id="blue-title-listar">Quantidade Desejada</p> 
                <input id="blue-input-cdst" type="number" value="" name="Inutilizar" autocomplete="off" required/>
            </td>
            <td id="colun-blue-table">
                <p id="blue-title-listar">Data Inutilização</p> 
                <input id="blue-input-cdst" type="date" value="" name="DataInutilizar" autocomplete="off" required/>
            </td>
            <td id="colun-blue-table">
