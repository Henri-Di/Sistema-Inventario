	...
	<!-- Title page -->
    <title>Sistema de Inventário - Diminuir Produto</title>	
...
<?php } ?>
    ...
    <form method="POST" action="CreateDiminuir.php">
    ...
    <button type="submit" id="blue-btn-cdst">Diminuir Produto  <i class="fa fa-level-down" id="blue-icon-btn-painel"></i></button>
