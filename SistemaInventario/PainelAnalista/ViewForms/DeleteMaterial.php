...
<?php } ?>
    ...
    <button type="submit" id="blue-btn-table-cadastro-produto" onclick="window.location.href='CreateDeleteMaterial.php?id=<?php echo $dado['ID'];?>';">Remover Material  <i class="fa fa-trash"></i></button>
