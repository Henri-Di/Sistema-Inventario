                ...
                <tr id="line-blue-table">
                    ...
                    <td id="colun-blue-table">
                        ...
                        <select id="select-form" name="Grupo">
                            ...
                            <?php
                            // Consulta para listar os grupos
                    ...
                    <td id="colun-blue-table">
                        ...
                        <input type="text" id="blue-input-cdst" value="<?php echo $produto['QUANTIDADE']; ?>" name="Quantidade" disabled>
                    </td>
                    ...
                    <td id="colun-blue-table">
                        ...
                        <select id="select-form" name="Localizacao">
                            ...
                            <?php
                            // Consulta para listar as localizações
                            $consulta_localizacoes = "SELECT * FROM LOCALIZACAO";
                            $result_localizacoes = mysqli_query($conn, $consulta_localizacoes);
                            while ($row = mysqli_fetch_array($result_localizacoes)) {
