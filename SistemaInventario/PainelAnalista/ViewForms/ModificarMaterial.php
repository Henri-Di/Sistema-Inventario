...
<?php } ?>
    ...
    <form method="POST" action="CreateModificaMaterial.php">
    ...
    $consulta = "SELECT * FROM MATERIAL WHERE id='$id'";
    ...
    <button type="submit" id="blue-btn-table-cadastro-produto">Modificar Material <i class="fa fa-pencil"></i></button>
