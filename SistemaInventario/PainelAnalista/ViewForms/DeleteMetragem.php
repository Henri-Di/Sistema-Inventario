...
<?php } ?>
    ...
    $consulta = "SELECT * FROM METRAGEM WHERE id='$id'";
    ...
    <input type="text" id="blue-input-cdst" name="Material" value="<?php echo $dado['METRAGEM'];?>" autocomplete="off" required disabled /><br>
    ...
    <button type="submit" id="blue-btn-table-cadastro-produto" onclick="window.location.href='CreateDeleteMetragem.php?id=<?php echo $dado['ID'];?>';">Remover Metragem  <i class="fa fa-trash"></i></button>
