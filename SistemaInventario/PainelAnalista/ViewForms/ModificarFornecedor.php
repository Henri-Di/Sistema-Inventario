    ...
    <form method="POST" action="CreateModificaFornecedor.php">
    ...
    <button type="submit" id="blue-btn-table-cadastro-produto">Modificar Fornecedor <i class="fa fa-pencil"></i></button>
