...
<?php } ?>
    ...
    <form method="POST" action="CreateModificaMetragem.php">
    ...
    <input type="text" id="blue-input-cdst" value="<?php echo $dado['ID']; ?>" name="id">
    ...
    require_once('ConnectionInventario.php'); 
    ...
    <button type="submit" id="blue-btn-table-cadastro-produto">Modificar Metragem <i class="fa fa-pencil"></i></button>
