...
<!-- Loop PHP para repetição de listagem -->
...
<div class="container-fluid" class="blue-container-btn-auxiliar-blue">
    <!-- Botões para os diferentes logs relacionados ao produto -->
    <button type="submit" id="blue-btn-relatorio-auxiliar-blue" onclick="window.location.href='../ViewLogs/LogAcrescimo.php?id=<?php echo $dado['IDPRODUTO'];?>';">
        Acréscimo <i class="fa fa-level-up" id="blue-icon-btn-painel"></i>
    </button>

    <button type="submit" id="blue-btn-relatorio-auxiliar-blue" onclick="window.location.href='../ViewLogs/LogSubtracao.php?id=<?php echo $dado['IDPRODUTO'];?>';">
        Diminuição <i class="fa fa-level-down" id="blue-icon-btn-painel"></i>
    </button>

    <button type="submit" id="blue-btn-relatorio-auxiliar-blue" onclick="window.location.href='../ViewLogs/LogSobrepor.php?id=<?php echo $dado['IDPRODUTO'];?>';">
        Sobrepor <i class="fa fa-refresh" id="blue-icon-btn-painel"></i>
    </button>

    <button type="submit" id="blue-btn-relatorio-auxiliar-blue" onclick="window.location.href='../ViewLogs/LogReserva.php?id=<?php echo $dado['IDPRODUTO'];?>';">
        Reserva <i class="fa fa-star" id="blue-icon-btn-painel"></i>
    </button>

    <button type="submit" id="blue-btn-relatorio-auxiliar-blue" onclick="window.location.href='../ViewLogs/LogDevolucao.php?id=<?php echo $dado['IDPRODUTO'];?>';">
        Devolução <i class="fa fa-exchange" id="blue-icon-btn-painel"></i>
    </button>

    <button type="submit" id="blue-btn-relatorio-auxiliar-blue" onclick="window.location.href='../ViewLogs/LogInutilizacao.php?id=<?php echo $dado['IDPRODUTO'];?>';">
        Inutilização <i class="fa fa-warning" id="blue-icon-btn-painel"></i>
    </button>

    <button type="submit" id="blue-btn-relatorio-auxiliar-blue" onclick="window.location.href='../ViewLogs/LogTransferencia.php?id=<?php echo $dado['IDPRODUTO'];?>';">
        Transferencia Saída <i class="fa fa-retweet" id="blue-icon-btn-painel"></i>
    </button>

    <button type="submit" id="blue-btn-relatorio-auxiliar-blue" onclick="window.location.href='../ViewLogs/LogTransferenciaRecebimento.php?id=<?php echo $dado['IDPRODUTO'];?>';">
        Transferencia Entrada <i class="fa fa-retweet" id="blue-icon-btn-painel"></i>
    </button>

    <button type="submit" id="blue-btn-relatorio-auxiliar-blue" onclick="window.location.href='../ViewLogs/LogNotaFiscal.php?id=<?php echo $dado['IDPRODUTO'];?>';">
...
<div class="container" id="footer-page">
    ...
    <!-- Fim do container do texto do rodapé -->

    <!-- Container para o ícone SVG -->
    ...
    <!-- Fim do container para o ícone SVG -->
</div>
