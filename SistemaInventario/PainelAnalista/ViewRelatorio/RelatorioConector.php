...
<head>
    ...
    <!-- Title page -->
    <title>Sistema de Inventário - Relatório Conector</title>
...
<div id="blue-line-title-btn-painel">
    <p id="blue-title-btn-painel">Relatório Conector <i class="fa fa-puzzle-piece" id="blue-icon-btn-painel"></i></p>
</div>
    ...
    <table class="table table-bordered" id="blue-table-cadastro-auxiliars">
        <tr id="line-blue-table-hover">
            <td id="colun-blue-table">
                ...
                <p id="blue-text-table-exibicao"><?php echo $dado['IDCONECTOR']; ?></p>
            </td>
            <td id="colun-blue-table">
            ...
            <td id="colun-blue-table">
                ...
                <div id="blue-optios-config-dados" onclick="window.location.href='../ViewForms/ModificarConector.php?id=<?php echo $dado['IDCONECTOR'];?>';">
                    <i class="fa fa-pencil" id="blue-icon-relatorio-produto"></i>
                </div>
            </td>
            <td id="colun-blue-table">
                <p id="blue-title-listar-exibicao">Remover</p> 
                <div id="blue-optios-config-dados" onclick="window.location.href='../ViewForms/DeleteConector.php?id=<?php echo $dado['IDCONECTOR'];?>';">
