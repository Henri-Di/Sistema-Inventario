...
if ($resultado = $conn->query($consulta)) {
    if ($resultado->num_rows > 0) {
        while ($row = $resultado->fetch_assoc()) { 
            // Convertendo a data de cadastro para o formato dd/mm/yyyy
...
<table class="table table-bordered" id="blue-table-cadastro-auxiliar">
    <tr id="line-blue-table-hover">
        ...
        <td id="colun-blue-table">
            <p id="blue-title-listar-exibicao">Nível de Acesso</p> 
...
<?php 
        ...
        echo '<p style="color:red; text-align:center;">Nenhum usuário encontrado.</p>';
    }
} else {
    echo '<p style="color:red; text-align:center;">Erro ao consultar usuários.</p>';
}
?>

</div>
<!-- End container for user list -->    
<br><br>
<!-- Rodapé da página -->
