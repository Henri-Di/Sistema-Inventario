...
<head>
    ...
    <!-- Title page -->
    <title>Sistema de Inventário - Relatorio Cadastros Auxiliares</title>
...
<div class="container-fluid">
    ...
    <!-- Título do bloco -->
    <p id="blue-title-btn-painel">Relatório Cadastros Auxiliares <i class="fa fa-puzzle-piece" id="blue-icon-btn-painel"></i></p>
</div>

<div class="container-fluid blue-container-btn-auxiliar">
    <!-- Botões de relatório para cada categoria -->
    <button type="submit" id="blue-btn-relatorio-auxiliar" onclick="window.location.href='../ViewRelatorio/RelatorioMaterial.php';">Material <i class="fa fa-puzzle-piece" id="blue-icon-btn-painel"></i></button>
    
    <button type="submit" id="blue-btn-relatorio-auxiliar" onclick="window.location.href='../ViewRelatorio/RelatorioConector.php';">Conector <i class="fa fa-puzzle-piece" id="blue-icon-btn-painel"></i></button>
    
    <button type="submit" id="blue-btn-relatorio-auxiliar" onclick="window.location.href='../ViewRelatorio/RelatorioMetragem.php';">Metragem <i class="fa fa-puzzle-piece" id="blue-icon-btn-painel"></i></button>
    
    <button type="submit" id="blue-btn-relatorio-auxiliar" onclick="window.location.href='../ViewRelatorio/RelatorioModelo.php';">Modelo <i class="fa fa-puzzle-piece" id="blue-icon-btn-painel"></i></button>
