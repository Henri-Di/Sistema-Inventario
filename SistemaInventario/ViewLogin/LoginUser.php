    ...
    if ($stmt) {
        ...
        if ($stmt->num_rows == 1) {
            ...
            if (password_verify($senha, $hashSenha)) {
                ...
                // Senha incorreta
                $_SESSION['loginErro'] = "<p style='color:red;font-weight:bold;margin-left:40%;font-size:12px;'>Credenciais inválidas!</p>";
        ...
        $_SESSION['loginErro'] = "<p style='color:red;font-weight:bold;margin-left:40%;font-size:12px;'>Erro no servidor. Tente novamente mais tarde.</p>";
        header("Location: ../Index.php");
        exit(); // Termina a execução do script após o redirecionamento
    }
