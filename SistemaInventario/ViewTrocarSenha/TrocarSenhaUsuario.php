...
<div class="container-fluid" id="blue-container-login">
    ...
    <!-- End logo page -->
        ...
        <form class="needs-validation" name="AcessoRestrito" id="blue-form-login" method="POST" action="../ViewTrocarSenha/CreateNovaSenhaUsuario.php" novalidate>
            ...
            <br>
            <div class="form-group">
                <input type="password" name="ConfirmarSenha" id="blue-input-login" placeholder="Confirmar nova senha" autocomplete="off" required>
                <div class="valid-feedback"></div>
                <div class="invalid-feedback"></div>
            </div>
            <br>
            <button type="submit" id="blue-btn-login">Confirmar</button>
        </form>
