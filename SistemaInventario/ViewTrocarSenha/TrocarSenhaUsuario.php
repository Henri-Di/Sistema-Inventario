    ...
    <div id="blue-line-title-btn-painel" style="width:30%;margin-left:49%;">
    


    <img src="../Images/images.png" class="logo2" style="margin-left:0%;">
    ...
    <div class="container-fluid" style="margin-left:48%;margin-top:1%;">
