...
// Converter o fornecedor para letras maiúsculas
...
if (mysqli_num_rows($result_check) > 0) {
    ...
    header("Location: ../ViewFail/FailCreateFornecedorExistente.php?erro=Não foi possível realizar o cadastro. O fornecedor já está cadastrado no sistema");
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        header("Location: ../ViewFail/FailCreateFornecedor.php?erro=Não foi possível realizar o cadastro do fornecedor. Tente novamente");
        exit(); // Termina a execução do script após redirecionamento
    }
}
