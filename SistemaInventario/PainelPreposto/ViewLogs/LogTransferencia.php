...
<div id="blue-line-title-btn-painel">
    <p id="blue-title-btn-painel">Confirmação Transferência <i class="fa fa-retweet" id="blue-icon-btn-painel" style="font-size:12px;"></i></p>
</div>
...
<div id="blue-line-title-btn-painel">
    <p id="blue-title-btn-painel">Log Transferência Saída <i class="fa fa-retweet" id="blue-icon-btn-painel" style="font-size:12px;"></i></p>
</div>
