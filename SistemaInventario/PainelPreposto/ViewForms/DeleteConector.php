...
<?php } ?>
    ...
    $consulta = "SELECT * FROM CONECTOR WHERE id='$id'";
    ...
    <input type="text" id="blue-input-cdst" name="Material" value="<?php echo $dado['CONECTOR'];?>" autocomplete="off" required disabled /><br>
    ...
    <button type="submit" id="blue-btn-table-cadastro-produto" onclick="window.location.href='CreateDeleteConector.php?id=<?php echo $dado['ID'];?>';">Remover Conector  <i class="fa fa-trash"></i></button>
