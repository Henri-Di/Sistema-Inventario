...
<?php } ?>
    ...
    <form method="POST" action="CreateModificaConector.php">
    ...
    <button type="submit" id="blue-btn-table-cadastro-produto">Modificar Conector <i class="fa fa-pencil"></i></button>
